...
def upgrade() -> None:
    with op.batch_alter_table("releasepolicy", schema=None) as batch_op:
        batch_op.add_column(sa.Column("github_compose_workflow_path", sa.String(), nullable=False))
        batch_op.add_column(sa.Column("github_vote_workflow_path", sa.String(), nullable=False))
        batch_op.add_column(sa.Column("github_finish_workflow_path", sa.String(), nullable=False))
