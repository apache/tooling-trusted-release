...
def upgrade() -> None:
    with op.batch_alter_table("workflowsshkey", schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column("github_uid", sa.String(), nullable=False, server_default=""))
        batch_op.add_column(sa.Column("github_nid", sa.Integer(), nullable=False, server_default=sa.text("0")))
